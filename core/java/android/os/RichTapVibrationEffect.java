...
public class RichTapVibrationEffect {
    ...
    public static final class PatternHeParameter extends VibrationEffect implements Parcelable {
        ...
        private PatternHeParameter(@NonNull Parcel in) {
            ...
            mFreq = in.readInt();
            Slog.d("PatternHeParameter", "parcel mInterval:" + this.mInterval + " mAmplitude:" + this.mAmplitude + " mFreq:" + this.mFreq);
        }
        ...
        public PatternHeParameter(int interval, int amplitude, int freq) {
            ...
            mAmplitude = amplitude;
            mFreq = freq;
            Slog.d(TAG, "mInterval:" + mInterval + " mAmplitude:" + mAmplitude + " mFreq:" + mFreq);
        }
        ...
        public void writeToParcel(@NonNull Parcel out, int flags) {
            ...
            out.writeInt(mAmplitude);
            out.writeInt(mFreq);
            Slog.d(TAG, "writeToParcel mInterval:" + mInterval + " mAmplitude:" + mAmplitude + " mFreq:" + mFreq);
        }
    }
