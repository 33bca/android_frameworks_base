...
public class RichTapVibratorService {
    ...
    private IRichtapVibrator getRichtapService() {
        synchronized (RichTapVibratorService.class) {
            if (sRichtapVibratorService == null) {
                String vibratorDescriptor = "android.hardware.vibrator.IVibrator/default";
    ...
    public RichTapVibratorService(boolean supportRichTap /** lets ignore that */, IRichtapCallback callback) {
        mCallback = callback;
    }
